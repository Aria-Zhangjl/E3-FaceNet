...
from training import training_loop_4_E3_Face
...
def setup_training_loop_kwargs(cfg):
    ...
    args.update({"training_set_kwargs": dict(class_name='training.dataset.ImageFolderDataset_4_mmceleba_text', data_dir=cfg.data, image_folder=cfg.image_folder,resolution=cfg.resolution, use_labels=False, max_size=None, xflip=False)})
    ...
    args.smooth_feat = cfg.smooth_feat
    args.smooth_feat_v2 = cfg.smooth_feat_v2
    args.smooth_feat_v3 = cfg.smooth_feat_v3
...
@hydra.main(config_path="conf", config_name="config_mmceleba")
def main(cfg: DictConfig):
    ...
    print(f'Training data:      {args.training_set_kwargs.data_dir}')
    print(f'Training duration:  {args.total_kimg} kimg')
    print(f'Number of images:   {args.training_set_kwargs.max_size}')
    print(f'Image resolution:   {args.training_set_kwargs.resolution}')
    print(f'Conditional model:  {args.training_set_kwargs.use_labels}')
    print(f'Dataset x-flips:    {args.training_set_kwargs.xflip}')
    print(f'resume_start:       {args.resume_start}')
    print()
